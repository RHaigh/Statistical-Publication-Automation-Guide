...
For the purposes of this demonstration, we will knit to an HTML document as this affords us a greater variety of packages and otuput. You may knit to Word and Pdf but you will not be able to use much of the content below. For me personally, I will recommend you output your work report in HTML and copy and paste content to Word manually, saving graphs as .png or .pdf documents to insert if necessary. This workflow may not be the perfect solution but in most cases, it solves the problem and for you as a data scientist/statistician. The only extra thing you need to do is to educate your team about this. 
