...
mtcars[1:5, ] %>%
  formattable()
```
Formattable may not seem very different from kable, the output certianly looks the same, but it can be used for some attractive visuals such as the table below where each cell will darken as the cell values increase: 
